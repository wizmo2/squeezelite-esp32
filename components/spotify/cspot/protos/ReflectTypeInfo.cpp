...
#include <vector>
#include "protobuf.h"
ReflectType reflectTypeInfo[92] = {
ReflectType::ofEnum(/* mine id */ ReflectTypeID::EnumReflectTypeID, /* name */ "ReflectTypeID", /* enum values */ std::move(std::vector<ReflectEnumValue>{   ReflectEnumValue("EnumReflectTypeID", 0),
   ...
   ReflectEnumValue("ClassImage", 56),
   ReflectEnumValue("ClassImageGroup", 57),
   ReflectEnumValue("ClassAlbum", 58),
   ReflectEnumValue("ClassArtist", 59),
   ReflectEnumValue("ClassTrack", 60),
   ReflectEnumValue("ClassEpisode", 61),
   ReflectEnumValue("OptionalOfEnumAudioFormat", 62),
   ReflectEnumValue("VectorOfClassImage", 63),
   ReflectEnumValue("OptionalOfClassImageGroup", 64),
   ReflectEnumValue("OptionalOfClassAlbum", 65),
   ReflectEnumValue("VectorOfClassArtist", 66),
   ReflectEnumValue("OptionalOfInt32", 67),
   ReflectEnumValue("VectorOfClassRestriction", 68),
   ReflectEnumValue("VectorOfClassAudioFile", 69),
   ReflectEnumValue("VectorOfClassTrack", 70),
   ReflectEnumValue("EnumMessageType", 71),
   ReflectEnumValue("EnumPlayStatus", 72),
   ReflectEnumValue("EnumCapabilityType", 73),
   ReflectEnumValue("ClassTrackRef", 74),
   ReflectEnumValue("ClassState", 75),
   ReflectEnumValue("ClassCapability", 76),
   ReflectEnumValue("ClassDeviceState", 77),
   ReflectEnumValue("ClassFrame", 78),
   ReflectEnumValue("OptionalOfUint32", 79),
   ReflectEnumValue("OptionalOfEnumPlayStatus", 80),
   ReflectEnumValue("OptionalOfUint64", 81),
   ReflectEnumValue("VectorOfClassTrackRef", 82),
   ReflectEnumValue("OptionalOfEnumCapabilityType", 83),
   ReflectEnumValue("VectorOfInt64", 84),
   ReflectEnumValue("VectorOfString", 85),
   ReflectEnumValue("OptionalOfInt64", 86),
   ReflectEnumValue("VectorOfClassCapability", 87),
   ReflectEnumValue("OptionalOfEnumMessageType", 88),
   ReflectEnumValue("OptionalOfClassDeviceState", 89),
   ReflectEnumValue("OptionalOfClassState", 90),
...
ReflectType::ofClass(
	/* mine type id */ ReflectTypeID::ClassImage, 
	/* name */ "Image", 
	/* fields */ std::move(std::vector<ReflectField>{ReflectField( /* typeID */ ReflectTypeID::OptionalOfVectorOfUint8, /* name */ "file_id", /* offset */ offsetof(Image, file_id), /* protobuf tag */ 1),
}), 
	/* size */ sizeof(Image), 
	__reflectConstruct<Image>,
	__reflectDestruct<Image>),
ReflectType::ofClass(
	/* mine type id */ ReflectTypeID::ClassImageGroup, 
	/* name */ "ImageGroup", 
	/* fields */ std::move(std::vector<ReflectField>{ReflectField( /* typeID */ ReflectTypeID::VectorOfClassImage, /* name */ "image", /* offset */ offsetof(ImageGroup, image), /* protobuf tag */ 1),
}), 
	/* size */ sizeof(ImageGroup), 
	__reflectConstruct<ImageGroup>,
	__reflectDestruct<ImageGroup>),
ReflectType::ofClass(
	/* mine type id */ ReflectTypeID::ClassAlbum, 
	/* name */ "Album", 
	/* fields */ std::move(std::vector<ReflectField>{ReflectField( /* typeID */ ReflectTypeID::OptionalOfVectorOfUint8, /* name */ "gid", /* offset */ offsetof(Album, gid), /* protobuf tag */ 1),
ReflectField( /* typeID */ ReflectTypeID::OptionalOfString, /* name */ "name", /* offset */ offsetof(Album, name), /* protobuf tag */ 2),
ReflectField( /* typeID */ ReflectTypeID::OptionalOfClassImageGroup, /* name */ "cover_group", /* offset */ offsetof(Album, cover_group), /* protobuf tag */ 17),
}), 
	/* size */ sizeof(Album), 
	__reflectConstruct<Album>,
	__reflectDestruct<Album>),
ReflectType::ofClass(
	/* mine type id */ ReflectTypeID::ClassArtist, 
	/* name */ "Artist", 
	/* fields */ std::move(std::vector<ReflectField>{ReflectField( /* typeID */ ReflectTypeID::OptionalOfVectorOfUint8, /* name */ "gid", /* offset */ offsetof(Artist, gid), /* protobuf tag */ 1),
ReflectField( /* typeID */ ReflectTypeID::OptionalOfString, /* name */ "name", /* offset */ offsetof(Artist, name), /* protobuf tag */ 2),
}), 
	/* size */ sizeof(Artist), 
	__reflectConstruct<Artist>,
	__reflectDestruct<Artist>),
ReflectType::ofClass(
...
ReflectField( /* typeID */ ReflectTypeID::OptionalOfClassAlbum, /* name */ "album", /* offset */ offsetof(Track, album), /* protobuf tag */ 3),
ReflectField( /* typeID */ ReflectTypeID::VectorOfClassArtist, /* name */ "artist", /* offset */ offsetof(Track, artist), /* protobuf tag */ 4),
...
ReflectField( /* typeID */ ReflectTypeID::VectorOfClassAudioFile, /* name */ "audio", /* offset */ offsetof(Episode, audio), /* protobuf tag */ 12),
	...
	ReflectType::ofVector(
		/* mine typeId */ ReflectTypeID::VectorOfClassImage,
		/* inner type id */  ReflectTypeID::ClassImage,
		/* size */ sizeof(std::vector<Image>),
		VectorOperations{
			.push_back = __VectorManipulator<Image>::push_back,
			.at = __VectorManipulator<Image>::at,
			.size = __VectorManipulator<Image>::size,
			.emplace_back =  __VectorManipulator<Image>::emplace_back,
			.clear = __VectorManipulator<Image>::clear,
			.reserve = __VectorManipulator<Image>::reserve,
		},
		__reflectConstruct<std::vector<Image>>,
		__reflectDestruct<std::vector<Image>>
	)
	...
	ReflectType::ofOptional(
		/* mine typeId */ ReflectTypeID::OptionalOfClassImageGroup,
		/* inner type id */  ReflectTypeID::ClassImageGroup,
		/* size */ sizeof(std::optional<ImageGroup>),
		/* option */ OptionalOperations{
			.get = __OptionalManipulator<ImageGroup>::get,
			.has_value = __OptionalManipulator<ImageGroup>::has_value,
			.set = __OptionalManipulator<ImageGroup>::set,
			.reset = __OptionalManipulator<ImageGroup>::reset,
			.emplaceEmpty =  __OptionalManipulator<ImageGroup>::emplaceEmpty,
		},
		__reflectConstruct<std::optional<ImageGroup>>,
		__reflectDestruct<std::optional<ImageGroup>>
	)
	...
	ReflectType::ofOptional(
		/* mine typeId */ ReflectTypeID::OptionalOfClassAlbum,
		/* inner type id */  ReflectTypeID::ClassAlbum,
		/* size */ sizeof(std::optional<Album>),
		/* option */ OptionalOperations{
			.get = __OptionalManipulator<Album>::get,
			.has_value = __OptionalManipulator<Album>::has_value,
			.set = __OptionalManipulator<Album>::set,
			.reset = __OptionalManipulator<Album>::reset,
			.emplaceEmpty =  __OptionalManipulator<Album>::emplaceEmpty,
		},
		__reflectConstruct<std::optional<Album>>,
		__reflectDestruct<std::optional<Album>>
	)
	...
	ReflectType::ofVector(
		/* mine typeId */ ReflectTypeID::VectorOfClassArtist,
		/* inner type id */  ReflectTypeID::ClassArtist,
		/* size */ sizeof(std::vector<Artist>),
		VectorOperations{
			.push_back = __VectorManipulator<Artist>::push_back,
			.at = __VectorManipulator<Artist>::at,
			.size = __VectorManipulator<Artist>::size,
			.emplace_back =  __VectorManipulator<Artist>::emplace_back,
			.clear = __VectorManipulator<Artist>::clear,
			.reserve = __VectorManipulator<Artist>::reserve,
		},
		__reflectConstruct<std::vector<Artist>>,
		__reflectDestruct<std::vector<Artist>>
	)
